...
export default function Contact() {
  return (
    <div className="min-h-screen px-6 py-12 text-white max-w-4xl mx-auto">
      ...
      {/* Header */}
      <h1 className="text-4xl font-extrabold neon-text mb-4">Contact</h1>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        {/* Email */}
        <div className="bg-black/40 border border-gray-700 rounded-xl p-5 shadow-md hover:shadow-[0_0_20px_#ff52d9] transition">
        ...
        {/* LinkedIn */}
        <div className="bg-black/40 border border-gray-700 rounded-xl p-5 shadow-md hover:shadow-[0_0_20px_#ff52d9] transition sm:col-span-2">
